          ...
          <v-card-text>
            ...
            <v-list>
              <v-list-item
                ...
                :subtitle="worker.work_type"
                :title="worker.user_email"
              >
                ...
                <template v-slot:append>
                  <v-chip :color="worker.status ? 'success' : 'error'">
                    {{ worker.status ? "Checked In" : "Checked Out" }}
                  </v-chip>
                </template>
              </v-list-item>
            </v-list>
...
// const db = useFirestore();
const workers = useCollection(collection(db, "attendance"));
// const auth = getAuth();
